...
#print "Got file '$name'..\n";
 ...
 #              print "Got a config file with basename: $base_name\n";
                  #print " .. and $base_name is ", (exists $name_map->{$base_name} ? "in " : "not in "), "the hash\n"; 
                ...
                print $base_name;
                  ...
                  #  write_file($name,$name_map,$regex);
                }
            }
        }
        else
